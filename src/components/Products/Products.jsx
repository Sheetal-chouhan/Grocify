   ...
   <section>
      ...
      {categories.map(category =>{
           return (
            ...
            ${activeTab === category ?'text-white bg-gradient-to-b from-orange-400 to-orange-500' : 'bg-zinc-100'}`}
      ...
      {/* prodcut listiner */}
        ...
        <Link to='/AllProduct' className='bg-gradient-to-b from-orange-400 to-orange-500 text-white px-8 py-3 rounded-lg md:text-lg text-md 
        hover:scale-105 hover:to-orange-600 transition-all duration-300 cursor-pointer '>View All</Link>
        </div>
      </div>
   </section>
  )
